/** Video-safe demo KPI data (mirrors lib/os/demo-data/dashboard.ts). */
export type Kpi = {
  label: string;
  value: string;
  delta?: number;
...
export function getDemoKpis(): Kpi[] {
  return [
    ...
    { label: "Inventory Value", value: "$12,840", hint: "42 items" },
    { label: "Waste (7d)", value: "$214", delta: -12, hint: "spoilage + overprod." },
    { label: "Low Stock", value: "3", hint: "below par" },
  ];
}
...
export const TAGLINE = "Atlanta Made. Cajun Soul.";
